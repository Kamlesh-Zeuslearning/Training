...
export default class RowResizer {
    ...
    addEventListeners() {
        ...
        rowHeaderCanvas.addEventListener("mousemove", (e) => this.onMouseMove(e));

        // Start resizing when mouse is pressed
        rowHeaderCanvas.addEventListener("mousedown", (e) => this.onMouseDown(e));
    ...
    onMouseMove(e) {
        ...
        for (let i = 0; i < this.spreadsheet.config.visibleRows; i++) {
            rowSum += this.spreadsheet.rowHeights[this.spreadsheet.currentStartRow + i];
    ...
    onMouseResize(e) {
        ...
        if (newHeight > 20) {  // Set a minimum height constraint
